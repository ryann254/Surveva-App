...
SizedBox passwordWidget(bool obscurePassword, Function setState) {
  return SizedBox(
    height: 50,
...
SizedBox emailWidget() {
  ...
  Row genderWidget(String gender, Function setState) {
    return Row(
                    children: [
                      Expanded(
                        flex: 1,
  ...
  SizedBox confirmPasswordWidget(bool obscureConfirmPassword, Function setState) {
    return SizedBox(
                    height: 50,
                    width: double.infinity,
                    child: TextField(
                      ...
                      decoration: InputDecoration(
                        ...
                        }, icon: obscureConfirmPassword ? const Icon(Icons.visibility_off) : const Icon(Icons.visibility))
                      ),
                    ),
                  );
  }
